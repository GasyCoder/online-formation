<x-app-layout>
<!-- ============================ Page Title Start================================== -->
<div class="bg-cover ed_detail_head" style="background:#f4f4f4 url(assets/img/banner-3.jpg);" data-overlay="8">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 col-md-7">
                <div class="ed_detail_wrap light">
                    ...
                    <div class="crs_cates cl_3"><span>Design</span></div>
                    ...
                    <div class="ed_header_short">
                        <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit
                            anim id est laborum. accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae
    ...
    <div class="container">
        <div class="row justify-content-between">
            ...
            <div class="col-lg-8 col-md-12 order-lg-first">
                ...
                <div class="mt-4 tab_box_info">
                    <ul class="mb-3 nav nav-pills light" id="pills-tab" role="tablist">
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="overview" role="tabpanel"
                            ...
                            <div class="edu_wraper">
                                ...
                                <ul class="lists-3 row">
                                    <li class="m-0 col-xl-4 col-lg-6 col-md-6">At vero eos et accusamus</li>
                                    <li class="m-0 col-xl-4 col-lg-6 col-md-6">At vero eos et accusamus</li>
                                    <li class="m-0 col-xl-4 col-lg-6 col-md-6">At vero eos et accusamus</li>
                                    <li class="m-0 col-xl-4 col-lg-6 col-md-6">At vero eos et accusamus</li>
                                    <li class="m-0 col-xl-4 col-lg-6 col-md-6">At vero eos et accusamus</li>
                        ...
                        <div class="tab-pane fade" id="curriculum" role="tabpanel" aria-labelledby="curriculum-tab">
                            <div class="edu_wraper">
                                ...
                                <div id="accordionExample" class="shadow accordion circullum">

                                    <!-- Part 1 -->
                                    <div class="card">
                                        <div id="headingOne" class="bg-white border-0 shadow-sm card-header">
                                            <h6 class="mb-0 accordion_title"><a href="#" data-toggle="collapse"
                                                    data-target="#collapseOne" aria-expanded="true"
                                                    aria-controls="collapseOne"
                                                    class="py-2 d-block position-relative text-dark collapsible-link">Part
                                                    01: How To Learn Web Designing Step by Step</a></h6>
                                        </div>
                                        <div id="collapseOne" aria-labelledby="headingOne"
                                            data-parent="#accordionExample" class="collapse show">
                                            <div class="pl-3 pr-3 card-body">
                                    ...
                                    <!-- Part 2 -->
                                    <div class="card">
                                        <div id="headingTwo" class="bg-white border-0 shadow-sm card-header">
                                            <h6 class="mb-0 accordion_title"><a href="#" data-toggle="collapse"
                                                    data-target="#collapseTwo" aria-expanded="false"
                                                    aria-controls="collapseTwo"
                                                    class="py-2 d-block position-relative collapsed text-dark collapsible-link">Part
                                    ...
                                    <!-- Part 3 -->
                                    <div class="card">
                                        <div id="headingThree" class="bg-white border-0 shadow-sm card-header">
                                            <h6 class="mb-0 accordion_title"><a href="#" data-toggle="collapse"
            ...
            <div class="col-lg-4 col-md-12 order-lg-last">
                ...
                <div class="ed_view_box style_3 ovrlio stick_top">
                    ...
                    <div class="property_video sm">
                        <div class="thumb">
                            <img class="pro_img img-fluid w100" src="assets/img/banner-3.jpg" alt="7.jpg">
                ...
                <div class="slide_items">
                        ...
                        <div class="crs_grid shadow_none brd">
                            <div class="crs_grid_thumb">
                                <a href="course-detail.html" class="crs_detail_link">
                                    <img src="assets/img/cr-2.jpg" class="rounded img-fluid" alt="" />
                                </a>
                            ...
                            <div class="crs_grid_caption">
                                <div class="crs_flex">
                                    ...
                                    <div class="crs_fl_last">
                                        <div class="crs_price">
                                            <h2><span class="currency">$</span><span class="theme-cl">149</span></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="crs_title">
                                    <h4><a href="course-detail.html" class="crs_title_link">Basic knowledge about
                                            hodiernal bharat in history</a></h4>
                                </div>
                                    ...
                                    <div class="crs_fl_first">
                                        <div class="crs_tutor">
                                            <div class="crs_tutor_thumb"><a href="instructor-detail.html"><img
                                                        src="assets/img/user-6.jpg" class="img-fluid circle"
                                                        alt="" /></a></div>
                                        </div>
                                    </div>
                                    <div class="crs_fl_last">
                    ...
                    <div class="lios_item">
                        <div class="crs_grid shadow_none brd">
                            <div class="crs_grid_thumb">
                                <a href="course-detail.html" class="crs_detail_link">
                                    <img src="assets/img/cr-3.jpg" class="rounded img-fluid" alt="" />
                                </a>
                                <div class="crs_video_ico">
                                    <i class="fa fa-play"></i>
                                </div>
                            ...
                            <div class="crs_grid_caption">
                                ...
                                <div class="crs_title">
                                    <h4><a href="course-detail.html" class="crs_title_link">Advance PHP knowledge with
                                            laravel to make smart web</a></h4>
                                </div>
                                <div class="crs_info_detail">
                                    <ul>
                            ...
                            <div class="crs_grid_foot">
                                <div class="crs_flex">
                                    <div class="crs_fl_first">
                                        <div class="crs_tutor">
                                            <div class="crs_tutor_thumb"><a href="instructor-detail.html"><img
                                                        src="assets/img/user-5.jpg" class="img-fluid circle"
                                                        alt="" /></a></div>
                                        </div>
                                    </div>
                                    <div class="crs_fl_last">
                    ...
                    <div class="lios_item">
                        <div class="crs_grid shadow_none brd">
                            <div class="crs_grid_thumb">
                                <a href="course-detail.html" class="crs_detail_link">
                                    <img src="assets/img/cr-4.jpg" class="rounded img-fluid" alt="" />
                                </a>
                                <div class="crs_video_ico">
                                    <i class="fa fa-play"></i>
                                </div>
                            ...
                            <div class="crs_grid_caption">
                                <div class="crs_flex">
                                    ...
                                    <div class="crs_fl_last">
                                        <div class="crs_price">
                                            <h2><span class="currency">$</span><span class="theme-cl">49</span></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="crs_title">
                                    <h4><a href="course-detail.html" class="crs_title_link">The complete accounting &
                                            bank financial course 2021</a></h4>
                                </div>
                                <div class="crs_info_detail">
                                    <ul>
                            ...
                            <div class="crs_grid_foot">
                                <div class="crs_flex">
                                    <div class="crs_fl_first">
                                        <div class="crs_tutor">
                                            <div class="crs_tutor_thumb"><a href="instructor-detail.html"><img
                                                        src="assets/img/user-4.jpg" class="img-fluid circle"
                                                        alt="" /></a></div>
                                        </div>
                                    </div>
                                    <div class="crs_fl_last">
                    ...
                    <div class="lios_item">
                        <div class="crs_grid shadow_none brd">
                            <div class="crs_grid_thumb">
                                <a href="course-detail.html" class="crs_detail_link">
                                    <img src="assets/img/cr-5.jpg" class="rounded img-fluid" alt="" />
                                </a>
                                <div class="crs_video_ico">
                                    <i class="fa fa-play"></i>
                                </div>
                            ...
                            <div class="crs_grid_caption">
                                ...
                                <div class="crs_title">
                                    <h4><a href="course-detail.html" class="crs_title_link">The complete business plan
                                            course includes 50 templates</a></h4>
                                </div>
                                <div class="crs_info_detail">
                                    <ul>
                            ...
                            <div class="crs_grid_foot">
                                <div class="crs_flex">
                                    <div class="crs_fl_first">
                                        <div class="crs_tutor">
                                            <div class="crs_tutor_thumb"><a href="instructor-detail.html"><img
                                                        src="assets/img/user-3.jpg" class="img-fluid circle"
                                                        alt="" /></a></div>
                                        </div>
                                    </div>
                                    <div class="crs_fl_last">
                    ...
                    <div class="lios_item">
                        <div class="crs_grid shadow_none brd">
                            <div class="crs_grid_thumb">
                                <a href="course-detail.html" class="crs_detail_link">
                                    <img src="assets/img/cr-6.jpg" class="rounded img-fluid" alt="" />
                                </a>
                                <div class="crs_video_ico">
                                    <i class="fa fa-play"></i>
                                </div>
                            ...
                            <div class="crs_grid_caption">
                                <div class="crs_flex">
                                    ...
                                    <div class="crs_fl_last">
                                        <div class="crs_price">
                                            <h2><span class="currency">$</span><span class="theme-cl">399</span></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="crs_title">
                                    <h4><a href="course-detail.html" class="crs_title_link">Full web designing course
                                            with 20 web template designing</a></h4>
                                </div>
                                <div class="crs_info_detail">
                                    <ul>
                            ...
                            <div class="crs_grid_foot">
                                <div class="crs_flex">
                                    <div class="crs_fl_first">
                                        <div class="crs_tutor">
                                            <div class="crs_tutor_thumb"><a href="instructor-detail.html"><img
                                                        src="assets/img/user-2.jpg" class="img-fluid circle"
                                                        alt="" /></a></div>
                                        </div>
                                    </div>
                                    <div class="crs_fl_last">
                    ...
                    <div class="lios_item">
                        <div class="crs_grid shadow_none brd">
                            <div class="crs_grid_thumb">
                                <a href="course-detail.html" class="crs_detail_link">
                                    <img src="assets/img/cr-7.jpg" class="rounded img-fluid" alt="" />
                                </a>
                                <div class="crs_video_ico">
                                    <i class="fa fa-play"></i>
                                </div>
                            ...
                            <div class="crs_grid_caption">
                                <div class="crs_flex">
                                    ...
                                    <div class="crs_fl_last">
                                        <div class="crs_price">
                                            <h2><span class="currency">$</span><span class="theme-cl">89</span></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="crs_title">
                                    <h4><a href="course-detail.html" class="crs_title_link">Sociology Optional: Test
                                            Series for UPSC CSE Mains (2021 & 2022)</a></h4>
                                </div>
                                <div class="crs_info_detail">
                                    <ul>
                                        <li><i class="fa fa-clock text-danger"></i><span>06 hr 07 min</span></li>
                            ...
                            <div class="crs_grid_foot">
                                <div class="crs_flex">
                                    <div class="crs_fl_first">
                                        <div class="crs_tutor">
                                            <div class="crs_tutor_thumb"><a href="instructor-detail.html"><img
                                                        src="assets/img/user-1.jpg" class="img-fluid circle"
                                                        alt="" /></a></div>
                                        </div>
                                    </div>
                                    <div class="crs_fl_last">
